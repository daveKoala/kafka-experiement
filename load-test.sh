...
for i in {1..10000}; do
    curl --silent --location 'localhost:8081/api/batch' \
         ...
         --data '[{"topic":"user-events","key":"user-123","value":{"action":"login","timestamp":"2025-06-27T10:30:00Z"},"headers":{"source":"web-app"}},{"topic":"application-metrics","key":"metric-456","value":{"name":"page_view","count":1}}]' &
